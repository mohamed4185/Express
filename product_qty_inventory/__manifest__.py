...
{
    'name' : 'Product qty inventory Report',
    'version' : '12.0.1',
    'summary': 'Product qty inventory Report' ,
    'sequence': 19,
    'category': 'inventory',
    'author' : 'BBL',
    'description': """
...
Also print report for particular duration.
    """,
    "license": "AGPL-3",
    'depends' : ['base_setup', 'sale_management','stock','move_product_in_to_out'],
    'data': [
        'wizard/wiz_periodical_report_view.xml',
        'views/periodical_report.xml',
        'views/report_periodical_purchase.xml'
    ],
