...
{
    'name' : 'Move product in',
    'version' : '12.0.1',
    'summary': 'Module move  product .',
    'sequence': 16,
    'category': 'Purchase',
    'author' : 'BBl',
    'description': """
...
Also print report for particular duration.
    """,
    "license": "AGPL-3",
    'depends' : ['base_setup', 'sale_management','base','move_product_in_to_out'],
    'data': [
        'wizard/wiz_periodical_report_view.xml',
        'views/move_in_report_product.xml',
        'views/report_move_in_product.xml'
    ],
