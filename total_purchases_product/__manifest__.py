...
{
    'name' : 'Total purchase Report for each product',
    'version' : '12.0.1',
    'summary': 'Module all purchase product .',
    'sequence': 16,
    'category': 'purchases',
    'author' : 'BBl',
    'description': """
...
Also print report for particular duration.
    ...
    'data': [
        ...
        'views/total_purchases_report_product.xml',
        'views/report_total_purchases_product.xml'
    ],
